...
class _HomeTabViewState extends ConsumerState<HomeTabView>
  ...
  String _getRemainingTime(DateTime startTime, DateTime endTime) {
  ...
  String _getRepeatLabel(int repeat, List<int> repeatDays) {
  ...
  String _getMoodEmoji(double moodRatio) {
                      ...
                      child: todoAsync.when(
                        data: (todos) {
                          final filtered = todos
                              .where(viewModel.shouldShowTodo)
                              .toList()
                            ..sort(
                              (a, b) => viewModel
                                  .resolveStart(a)
                                  .compareTo(viewModel.resolveStart(b)),
                            );
                          if (filtered.isEmpty) {
                          ...
                          return ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              final completed = viewModel.isCompletedToday(todo);
                              return Card(
                                elevation: 0,
                                      ...
                                      Text(
                                        () {
                                          if (todo.repeat ==
                                            ...
                                            final times =
                                                viewModel.weeklyEffectiveTimes(
                                              todo,
                                            );
                                            return _getRemainingTime(
                                              times.start,
                                              times.end,
                                            );
                                          }
